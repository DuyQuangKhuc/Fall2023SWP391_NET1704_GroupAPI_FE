...
import { useGetProductSizeQuery, useGetProducts1Query, useGetProducts2Query, useGetProductsQuery, useSearchProductByNameQuery } from '../slices/productsApiSlice';
...
const SearchScreen = () => {
    ...
    const { data: searchProductByName, isLoading, error, } = useSearchProductByNameQuery(keyword)
    return (
                ...
                <>
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <h1 className='mt-4'>Tìm với từ khóa '{keyword}'</h1>
                            <Message variant='success'>
                                <h4>Không tìm thấy sản phẩm với từ khóa '{keyword}'</h4>
                            </Message>
                        </>
                    ) : (
                        <>
                            ...
                            <Row>
                                ...
                                {searchProductByName?.map((product) => (
